...
#define RCC_APBENR1_USART6EN		(1 << 9)
#define RCC_APBENR1_USART5EN		(1 << 8)
...
#define RCC_APBSMENR1_LPUART2SMEN		(1 << 7)
#define RCC_APBSMENR1_USART6SMEN		(1 << 9)
#define RCC_APBSMENR1_USART5SMEN		(1 << 8)
...
#define RCC_CCIPR_LPUART2SEL_MASK		0x3
#define RCC_CCIPR_LPUART2SEL_SHIFT		8
/** @defgroup rcc_ccipr_lpuart2sel LPUART2SEL LPUART2 Clock source selection
@{*/
#define RCC_CCIPR_LPUART2SEL_PCLK			0
#define RCC_CCIPR_LPUART2SEL_SYSCLK			1
#define RCC_CCIPR_LPUART2SEL_HSI16			2
#define RCC_CCIPR_LPUART2SEL_LSE			3
/**@}*/
...
enum rcc_periph_clken {
	...
	RCC_CAN1 = _REG_BIT(RCC_APBENR1_OFFSET, 12),
	RCC_CAN2 = _REG_BIT(RCC_APBENR1_OFFSET, 12),
